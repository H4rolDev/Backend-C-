        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    RSocial = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UltPorcUtilidad = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    id_empleadoTecnico = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ordenServicioTecnico_empleadoTecnico_id_empleadoTecnico",
                        column: x => x.id_empleadoTecnico,
            ...
            migrationBuilder.InsertData(
                table: "productos",
                columns: new[] { "id", "UltPorcUtilidad", "descripcion", "garantia", "id_categoria", "imagen", "marca", "modelo", "precioVenta", "stock" },
                values: new object[,]
                {
                    { 1, null, "B550M, SSD M.2 1TB, RAM 16GB", 2, 1, "https://www.impacto.com.pe/storage/pc/sm/171570984947559.jpg", "AMD", "Ryzen 7 5700G", 3298.80m, 10 },
                    { 2, null, "Tarjeta de Video RTX 3050, SSD M.2 1TB, RAM 16GB", 2, 1, "https://www.impacto.com.pe/storage/pc/md/171589130599320.jpg", "Intel", "Core I5 13400F", 2170.50m, 30 },
                    { 3, null, "Tarjeta de Video RTX 3060TI, SSD M.2 1TB, RAM 32GB", 2, 1, "https://www.impacto.com.pe/storage/pc/sm/171570984947559.jpg", "AMD", "Ryzen 9 5900X", 4239.99m, 10 },
                    { 4, null, "Tarjeta de Video RTX 4060, SSD M.2 1TB, RAM 32GB", 2, 1, "https://www.impacto.com.pe/storage/pc/sm/171570984947559.jpg", "AMD", "Ryzen 7 5700X", 4198.50m, 10 },
                    { 5, null, "Con Microfono, Control De Volumen, Almohadillas Suaves", 1, 3, "https://www.impacto.com.pe/storage/pc/md/171572299747960.jpg", "Logitech", "Lightspeed Rgb G733 Gaming", 538.99m, 3 },
                    { 6, null, "Inalambrico, Con Microfono, Control De Volumen, Almohadillas Suaves", 1, 3, "https://www.impacto.com.pe/storage/products/sm/169099476727139.jpg", "Logitech", "G Pro X Gaming", 638.99m, 3 },
                    { 7, null, "Inalambrico, Necro C/gris, Gaming Surrow 7.1, C/microfono, Entrada Jack", 1, 3, "https://www.impacto.com.pe/storage/products/sm/168867107289840.jpg", "Gambyte ", "Dark Templar", 128.99m, 3 },
                    { 8, null, "Inalambrico, Necro C/gris, Gaming Surrow 7.1, C/microfono, Entrada Jack", 1, 3, "https://www.impacto.com.pe/storage/products/sm/168867107289840.jpg", "Gambyte ", "Dark Templar", 128.99m, 3 },
                    { 9, null, "Color Negro, Gaming 5.1, Bluetooth 5.0, Con Microfono, Control De Volumen, Almohadillas Suaves", null, 6, "https://www.impacto.com.pe/storage/products/sm/169099387290344.jpg", "Gambyte", "Soul", 120.99m, 23 }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ordenServicioTecnico_id_empleadoTecnico",
                table: "ordenServicioTecnico",
                column: "id_empleadoTecnico");
